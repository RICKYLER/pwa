  ...
  async function persistReview(nextStatus?: HouseholdRegistrationStatus) {
    ...
    try {
      const updated = await updateHousehold(selectedHousehold.id, {
        ...
        location_verified_by: reviewDraft.location_verified ? user.name : undefined,
        ...
        registration_reviewed_by: nextStatus ? user.name : selectedHousehold.registration_reviewed_by,
