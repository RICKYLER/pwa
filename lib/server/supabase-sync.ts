  ...
  switch (item.entity_type) {
    ...
    case 'vulnerability_flags':
      return {
        ...
        is_infant: toBooleanValue(data.is_infant),
        ...
        pregnancy_months: toOptionalNumber(data.pregnancy_months) ?? undefined,
        expected_delivery_date: toDateOnly(data.expected_delivery_date) ?? undefined,
        is_pwd: toBooleanValue(data.is_pwd),
        is_4ps: toBooleanValue(data.is_4ps),
        is_indigent: toBooleanValue(data.is_indigent),
