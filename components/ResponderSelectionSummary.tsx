...
import { AlertTriangle, Home, MapPin, Navigation, Phone, Radio, X } from 'lucide-react';
...
export default function ResponderSelectionSummary({
  ...
  if (!household && !incident) {
    return (
      <CivicPanel>
        <CivicSectionHeading
          icon={MapPin}
          title="Map selection"
          description="Select a household or incident from the map to inspect details here."
        />
      </CivicPanel>
    );
  }
