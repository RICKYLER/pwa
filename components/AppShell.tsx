    ...
    <>
      ...
      <Dialog open={Boolean(accessIssue)}>
        <DialogContent
          ...
          className="max-w-md rounded-xl border-slate-200 bg-white p-0 shadow-lg"
        >
          <div className="rounded-t-xl bg-amber-50 px-6 py-5">
          ...
          <div className="px-6 pb-6 pt-5">
            ...
            <DialogFooter className="mt-5">
              <button
                ...
                className="inline-flex h-[48px] w-full items-center justify-center gap-2 rounded-lg bg-cyan-950 px-4 text-sm font-semibold text-white transition hover:bg-cyan-900 disabled:cursor-not-allowed disabled:opacity-60"
              >
